...
class AjaxController extends Controller {
    ...
    public function deleteLink(Request $request) {
        //self::ensureAdmin(); //Permitimos borrar el link a usuarios no administradores
    ...
    public function toggleLink(Request $request) {
        //self::ensureAdmin(); // Permitimos activar/desactivar links a usuarios no adminsitradores
        ...
        return ($new_status ? "Habilitar" : "Deshabilitar");
    }
}
